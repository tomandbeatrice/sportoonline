                ...
                <tr class="{{ $file->status === 'failed' ? 'table-danger' : ($file->status === 'deleted' ? 'table-warning' : '') }}">
                    ...
                    <td>
                        ...
                        @elseif($file->status === 'failed')
                            <form method="POST" action="{{ route('admin.export.files.retry', $file->id) }}" class="d-inline">
                                @csrf
                                <button type="submit" class="btn btn-sm btn-warning">Tekrar Dene</button>
                            </form>
                        @else
