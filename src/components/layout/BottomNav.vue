    ...
    <div class="flex h-16 items-center justify-around px-2">
      ...
      <div class="relative -top-5">
        ...
        >
          ...
          <svg v-else-if="currentModule === 'transport'" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const handleSuperAction = () => {
  ...
  } else if (currentModule.value === 'transport') {
    // Quick ride
    alert('Hızlı Araç Çağır')
  } else {
    // General quick menu
