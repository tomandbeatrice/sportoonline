<template>
  ...
  <section class="flash-sales py-4">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
      <div v-for="item in flashSales" :key="item.id" class="bg-white rounded-xl border border-slate-100 p-4 hover:shadow-md transition-all">
        <div class="relative h-32 bg-slate-50 rounded-lg flex items-center justify-center text-5xl mb-3">
          {{ item.image }}
...
const flashSales = ref([
  { id: 1, title: 'Akıllı Bileklik', price: 450, oldPrice: 600, image: '⌚', sold: 85, total: 100 },
  { id: 2, title: 'Kablosuz Mouse', price: 250, oldPrice: 350, image: '🖱️', sold: 45, total: 120 },
  { id: 3, title: 'Powerbank 20000mAh', price: 550, oldPrice: 800, image: '🔋', sold: 92, total: 100 },
  { id: 4, title: 'Bluetooth Hoparlör', price: 750, oldPrice: 1100, image: '🔊', sold: 20, total: 50 }
])
